...
function mobilePage(workerName) {
  ...
  + '  inp.type="text";inp.className="report-notes";inp.placeholder="Dodatkowy wpis...";\n'
  + '  inp.style.marginTop="0";\n'
  + '  inp.addEventListener("input",function(){\n'
  + '    var rows=document.querySelectorAll(".extra-row");\n'
  + '    if(rows[rows.length-1]===row&&this.value.trim())addExtraRow();\n'
  + '  });\n'
  + '  row.appendChild(inp);table.appendChild(row);\n'
  + '}\n'
  + 'function initExtraRows(rpt){\n'
  + '  document.querySelectorAll(".extra-row").forEach(function(r){r.parentNode.removeChild(r);});\n'
  + '  var extras=(rpt&&rpt.extra)||[];\n'
  + '  extras.forEach(function(val){addExtraRow();var rows=document.querySelectorAll(".extra-row");rows[rows.length-1].querySelector("input").value=val;});\n'
  + '  addExtraRow();\n'
  + '}\n'
  + 'function getReport(){\n'
  + '  var extra=[];document.querySelectorAll(".extra-row input").forEach(function(el){var v=el.value.trim();if(v)extra.push(v);});\n'
  + '  return{poszwa:parseInt(document.getElementById("r-poszwa").value)||0,poszewki:parseInt(document.getElementById("r-poszewki").value)||0,przes_sr:parseInt(document.getElementById("r-przes-sr").value)||0,przes_duze:parseInt(document.getElementById("r-przes-duze").value)||0,recz_duzy:parseInt(document.getElementById("r-recz-duzy").value)||0,recz_sredni:parseInt(document.getElementById("r-recz-sredni").value)||0,dywanik:parseInt(document.getElementById("r-dywanik").value)||0,narzuta:parseInt(document.getElementById("r-narzuta").value)||0,koldra:parseInt(document.getElementById("r-koldra").value)||0,poduszka:parseInt(document.getElementById("r-poduszka").value)||0,podklad:parseInt(document.getElementById("r-podklad").value)||0,extra:extra};\n'
  + '}\n'
