...
function mobilePage(workerName) {
  ...
  + '    var statusTxt=done?"\u2713 Czyste":cleaning?"\ud83e\uddf9 Sprz\u0105tanie":vacated?"\ud83d\udd14 Pusty \u2014 wejd\u017a!":"Czeka na wyjazd";\n'
  + '    var statusCls=done?"s-done":cleaning?"s-clean":vacated?"s-open":"s-wait";\n'
  + '    var arr=vacated?"&#9654;":done?"&#10003;":"&#8250;";\n'
  + '    var arrCls=vacated?" vacated":"";\n'
  + '    html+="<div class=\\""+cls+"\\" onclick=\\"openRoom(\'"+r.no+"\')\\">";\n'
  + '    html+="<div class=\\""+rnoCls+"\\">"+r.no+"</div>";\n'
  + '    html+="<div class=\\"card-info\\"><div class=\\"card-type\\">"+(r.type||"")+"</div><div class=\\"card-status "+statusCls+"\\">"+statusTxt+"</div></div>";\n'
